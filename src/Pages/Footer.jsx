...
import { footerTranslations } from "../Data/Translations/ComponentTranslations"
...
export default function Footer()
{
    ...
    return <footer className = "bg-black text-gray-400 text-center py-6 text-sm">
        &copy; {new Date().getFullYear()} - João Pedro. {footerTranslations["copyright"][currentLanguage]}
